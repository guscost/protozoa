...
## Usage
See [page source](index.html) for an ES5 example. The `protozoa` package is also available on NPM.
...
See [page source](index.html) for an example using a flux-like message bus.
